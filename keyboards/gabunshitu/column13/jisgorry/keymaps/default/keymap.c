...
#define s(KC) RSFT(KC)
#define KL_NUMLK DF(_NUMLK)
#define KL_UNLOK DF(_QWERTY)
...
[_LOWER] = LAYOUT(
    KL_NUMLK,  KC_1,      KC_2,      KC_3,      KC_4,      KC_5,      KC_6,      KC_7,      KC_8,      KC_9,      KC_0,      JP_CIRC,   KC_DEL,
    _______,   sft(KC_1), sft(KC_2), sft(KC_3), sft(KC_4), sft(KC_5), sft(KC_6), sft(KC_7), sft(KC_8), sft(KC_9), JP_LBRC,   _______,
    KC_RSFT,   KC_A,      KC_B,      KC_C,      KC_D,      KC_E,      KC_F,      KC_X,      _______,   _______,   KC_PGUP,   JP_RBRC,
...
[_RAISE] = LAYOUT(
    ...
    KC_RSFT,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   KC_INS,    _______,
...
[_NUMLK] = LAYOUT(
    KL_UNLOK,  KC_1,      KC_2,      KC_3,      KC_4,      KC_5,      KC_6,      KC_7,      KC_8,      KC_9,      KC_0,      _______,   _______,
    _______,   sft(KC_1), sft(KC_2), sft(KC_3), sft(KC_4), sft(KC_5), sft(KC_6), sft(KC_7), sft(KC_8), sft(KC_9), _______,   _______,
    _______,   KC_A,      KC_B,      KC_C,      KC_D,      KC_E,      KC_F,      KC_X,      _______,   _______,   _______,   _______,
    _______,   _______,   _______,   _______,   _______,              s(JP_SCLN),s(JP_COLN),_______,   _______,   _______,   _______
),
};
